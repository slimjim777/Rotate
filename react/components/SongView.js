...
var SongView = React.createClass({
  ...
  getChart: function(attachmentId) {
    var self = this;
  ...
  renderSongLyric: function(chord, lyric, index) {
    return (
