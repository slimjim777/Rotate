...
class SetListDetail extends Component {
  ...
  handleChangeRowField(field, value) {
    var self = this;
  ...
  renderRowIsEditing(row, rowIndex, checked) {
    if (this.state.isEditing) {
      return (
        <td>
